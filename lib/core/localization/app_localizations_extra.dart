...
const Map<String, Map<String, String>> _extraLocalizedValues = {
  'en': {
    ...
    'nav_landing_cms': 'Landing Page CMS',
    'payment_plans': 'Subscription Plans',
    'payment_select_plan': 'Select a Plan',
    'payment_methods': 'Payment Methods',
    'payment_manual_instruction': 'Manual Payment Instructions',
    'payment_upload_screenshot': 'Upload Payment Screenshot',
    'payment_confirm': 'Confirm Payment',
    'payment_success': 'Payment Successful',
    'payment_failed': 'Payment Failed',
    'sub_active': 'Active',
    'sub_expired': 'Expired',
    'sub_pending': 'Pending Approval',
    'admin_transactions': 'Transactions Management',
    'admin_approve': 'Approve Payment',
    'admin_reject': 'Reject',
    'admin_no_transactions': 'No transactions found',
  ...
  'ar': {
    ...
    'nav_landing_cms': 'إدارة اللاندنج بيدج',
    'payment_plans': 'خطط الاشتراك',
    'payment_select_plan': 'اختر الخطة المناسبة',
    'payment_methods': 'طرق الدفع',
    'payment_manual_instruction': 'تعليمات الدفع اليدوي',
    'payment_upload_screenshot': 'ارفع صورة التحويل',
    'payment_confirm': 'تأكيد الدفع',
    'payment_success': 'تم الدفع بنجاح',
    'payment_failed': 'فشل عملية الدفع',
    'sub_active': 'نشط',
    'sub_expired': 'منتهي',
    'sub_pending': 'في انتظار المراجعة',
    'admin_transactions': 'إدارة التحويلات',
    'admin_approve': 'تأكيد الدفع',
    'admin_reject': 'رفض',
    'admin_no_transactions': 'لا توجد تحويلات حالياً',
    // add more keys here if you want
  },
};
